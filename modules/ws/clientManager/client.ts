...
export default class Client {
    ...
    public sendMessage(message: string) {
        clientManager.messageParser.addMessage(new ChatMessage("outgoingChatMessage", message, this.username, Date.now()));
    ...
    public showClientSideMessage(message: string) {
        clientManager.messageParser.addMessage(new ChatMessage("outgoingPrivateMessage", message, this.username, Date.now()));
